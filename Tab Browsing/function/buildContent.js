const buildContent = () => {
    ...
    tabContent1.classList.add('tab-content', 'c-one',);
    tabContent2.classList.add('tab-content', 'c-two');
    tabContent3.classList.add('tab-content', 'c-three');
    tabContent4.classList.add('tab-content', 'c-four');
